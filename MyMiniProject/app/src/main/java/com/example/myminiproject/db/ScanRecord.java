...
public class ScanRecord {
    ...
    public ScanRecord(@NonNull String scanId, String patientName, Long scanTimestamp, Double baselinePupilSize, Double minimumPupilSize, Long constrictionLatencyMs, String triageResult, Boolean isSynced) {
        this.scanId = scanId;
    ...
    public void setScanId(@NonNull String scanId) {
        this.scanId = scanId;
    }
